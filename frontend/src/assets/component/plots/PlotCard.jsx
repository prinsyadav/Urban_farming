...
//               <Input id="plot_id" placeholder="Enter plot ID" />
//             </div>

//             <div className="flex flex-col space-y-1.5">
//               <Label htmlFor="owner_id">Farmer ID</Label>
//               <Input id="owner_id" placeholder="Enter farmer ID" />
//             </div>
...
//               <Input id="location" placeholder="Enter plot location" />
//             </div>
...
//               <Input id="lease_start" type="date" />
//             </div>

//             <div className="flex flex-col space-y-1.5">
//               <Label htmlFor="lease_end">Lease End Date</Label>
//               <Input id="lease_end" type="date" />
//             </div>
//           </div>
//         </form>
//       </CardContent>
