...
export function CropRotationEditForm({
  rotation,
  onRotationUpdated,
  onCancel,
  plots = [],
  ...
  const [formData, setFormData] = useState({
    plot_id: rotation?.plot_id || "",
    previous_crop: rotation?.previous_crop || "",
    next_crop: rotation?.next_crop || "",
    rotation_date: rotation?.rotation_date
      ? new Date(rotation.rotation_date)
      : new Date(),
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error("Failed to update crop rotation");
    } finally {
